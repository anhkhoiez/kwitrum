...
--Key
wait(0.1)
KwiNotify("Thanks for using Kwi Hub !",5)
wait(0.1)
KwiNotify("https://discord.gg/b6sPnYYE",5)
wait(0.5)
local Notification = require(game:GetService("ReplicatedStorage").Notification)
Notification.new("<Color=Cyan>KwiScript<Color=/>"):Display()
wait(0.5)
Notification.new("<Color=Yellow>Create By khoisdz<Color=/>"):Display()
wait(1)
repeat
    wait()
